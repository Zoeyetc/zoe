...
import type { AudioEvent, AudioFrame, AudioMap, AudioSnapshot, TransportState } from '../types.ts';
...
export function createZlandListeningAdapter(map: AudioMap): ZlandListeningAdapter {
